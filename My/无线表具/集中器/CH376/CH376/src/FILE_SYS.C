...
UINT8	CH376ReadBlock( PUINT8 buf )
{
  ...
  /**********************************************************************
	...
	函数名：CH376WriteReqBlock
	输入：
	输出：
	功能：向内部指定缓冲区写入请求的数据块,返回长度 
	***********************************************************************/
...
/*	for ( i = MAX_FILE_NAME_LEN; i != 0; -- i ) {
  ...
  /**********************************************************************
	...
	函数名：CH376Read32bitDat
	输入：none
	输出：32位的数据
	功能：从CH376芯片读取32位的数据并结束命令
	***********************************************************************/
...
UINT8	CH376FileOpen( PUINT8 name )  /* 在根目录或者当前目录下打开文件或者目录(文件夹) */
{
  ...
  /**********************************************************************
	...
	输入：新建的文件名指针
	输出：操作中断状态
	功能：在根目录或者当前目录下新建文件,如果文件已经存在那么先删除 
	***********************************************************************/
UINT8	CH376FileCreate( PUINT8 name )  /* 在根目录或者当前目录下新建文件,如果文件已经存在那么先删除 */
{
  ...
  /**********************************************************************
	...
	输入：目录（文件夹）名称
	输出：操作中断状态
	功能：在根目录下新建目录(文件夹)并打开,如果目录已经存在那么直接打开 ,只能新建一级子目录
	***********************************************************************/
...
UINT8	CH376SeparatePath( PUINT8 path )  /* 从路径中分离出最后一级文件名或者目录(文件夹)名,返回最后一级文件名或者目录名的字节偏移 */
{
  ...
  /**********************************************************************
	...
	函数名：CH376FileOpenDir
	输入：
	输出：
	功能：打开多级目录下的文件或者目录的上级目录,支持多级目录路径,
...
/* StopName 指向最后一级文件名或者目录名 */
{
  ...
  /**********************************************************************
	...
	函数名：CH376FileOpenPath
	输入：
	输出：
	功能：打开多级目录下的文件或者目录(文件夹),支持多级目录路径,
        支持路径分隔符,路径长度不超过255个字符 
	***********************************************************************/
UINT8	CH376FileOpenPath( PUINT8 PathName )  /* 打开多级目录下的文件或者目录(文件夹),支持多级目录路径,支持路径分隔符,路径长度不超过255个字符 */
{
  ...
  /**********************************************************************
	...
	函数名：CH376FileCreatePath
	输入：
	输出：
	功能：新建多级目录下的文件,支持多级目录路径,支持路径分隔符,
        路径长度不超过255个字符
	***********************************************************************/
...
UINT8	CH376DirCreatePath( PUINT8 PathName )  /* 新建多级目录下的目录(文件夹)并打开,支持多级目录路径,支持路径分隔符,路径长度不超过255个字符 */
{
  ...
  /**********************************************************************
	...
	输入：
	输出：
	功能：删除文件,如果已经打开则直接删除,否则对于文件会先打开再删除,支持多级目录路径 
	***********************************************************************/
